...
def modularGP_CellaMethod(file_path, outbox, n_run, MAX_DEPTH, N_GENERATIONS, N_POPULATION, N_ITERATIONS, N_IND_TO_KEEP, KERNEL_SIZE, const):
    MIN_DEPTH = 4
...
'''
# here a demostration that editing c does not affect the successive calls 
