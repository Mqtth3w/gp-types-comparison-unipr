...
def ui():
    ...
    button = tk.Button(frame, text="Run", command=lambda: start_tasks(root, message_label, outbox1, outbox2, outbox3,
                                                                      n_run_spinbox.get(), max_depth_spinbox.get(), 
                                                                      selected_option_generation.get(), selected_option_popolation.get(), 
                                                                      selected_option_iteration.get(), ind_to_keep_spinbox.get(),
                                                                      kernel_size_option.get()))
